...
export default function Sidebar() {
  return (
    <aside className="menu bg-base-200 flex flex-col items-center w-20 rounded-box p-2 gap-4">
      <li>
      ...
      <li>
        <Link href="/results" className="tooltip tooltip-right" data-tip="Details">
          {/* icon Info */}
          <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7"
            fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
      ...
      <li>
        <Link href="/reports" className="tooltip tooltip-right" data-tip="Stats">
          {/* icon Stats */}
          <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7"
            fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
              ...
              002 2h2a2 2 0 002-2m0 0V5a2
              2 0 012-2h2a2 2 0 012 2v14a2
